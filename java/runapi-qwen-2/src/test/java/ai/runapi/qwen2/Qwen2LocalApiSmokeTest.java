...
import ai.runapi.qwen2.types.TextToImageResponse;
    ...
    class Qwen2LocalApiSmokeTest {
      ...
      void startServer() throws IOException {
        ...
        server.createContext("/api/v1/qwen_2/text_to_image", this::handleRequest);
        server.start();
      }
      ...
      CompletedTextToImageResponse response =
        ...
        assertEquals("/api/v1/qwen_2/text_to_image", create.path);
      ...
      private void handleRequest(HttpExchange exchange) throws IOException {
        ...
        assertEquals("/api/v1/qwen_2/text_to_image/task_local_123", captured.path);
